...
a[0]["class"]},closeModal:function(){this.$parent.resetSortOptions();this.$router.push({name:"indexRoute"})},showSortOption:function(a){return"az"===a?"A-Z":a.charAt(0).toUpperCase()+a.slice(1)},onScroll:function(a){this.$parent.scroll_position=a.target.scrollTop;this.checkImagesPosition()},onTemplatesUpdate:function(){var a=this;a.$nextTick(function(){a.checkImagesPosition()})},onWindowResize:function(){this.checkImagesPosition()},checkImagesPosition:function(){var a=this;a.$refs.loadContent.querySelectorAll(".tdb-template-wrap").forEach(function(b){!0!==
b.classList.contains("td-lazy-image-loaded")&&a.isElementInViewport(b)&&a.templateInView(b.dataset.id)})},isElementInViewport:function(a){a=a.getBoundingClientRect();var b=a.left,c=a.bottom,d=a.right,f=a.height,e=a.width,g=this.$refs.loadContent;return 0<=a.top+f&&0<=b+e&&c-f<=g.clientHeight+300&&d-e<=g.clientWidth+300},templateInView:function(a){var b=this.$parent.sorted_templates.findIndex(function(b){return parseInt(b.ID)===parseInt(a)});this.$parent.sorted_templates[b].img_is_loaded=!0}},components:{error:window.tdbVue.error}};
window.tdbVue.routes=[{path:"/",component:window.tdbVue.index,name:"indexRoute",children:[{path:"load",component:window.tdbVue.load,name:"loadRoute",props:!0},{path:"single/:wpType/:templateType/:templateId",component:window.tdbVue.single,name:"singleRoute",props:!0},{path:"install/:templateId",component:window.tdbVue.install,name:"installRoute",props:!0}]}];
