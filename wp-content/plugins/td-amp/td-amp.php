 ...
 * Author: tagDiv
 * Version: 1.2 | built on 27.06.2018 14:16
...
//hash
define('TD_AMP', '5a872788968238b3c07bbc1f74d008b6');
...
add_action('td_global_after', 'td_amp_on_td_global_after');
function td_amp_on_td_global_after() {
	if (td_amp_version_check::is_theme_compatible() === false) {
		//todo - initialization stoped but 'templates/functions.php' is still loaded by the theme
		return;
	}
