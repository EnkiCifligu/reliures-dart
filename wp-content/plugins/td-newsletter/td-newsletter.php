...
Author: tagDiv
Version: 1.1 | built on 27.06.2018 14:16
Author URI: http://tagdiv.com
*/


//hash
define('TD_NEWSLETTER', 'ef572c6b13d4c30c1f551febd1743758');
...
class td_api_newsletter {
    ...
    static function tdn_plugin_wpadmin_css() {
        wp_enqueue_style('td-plugin-newsletter', plugins_url('', __FILE__) . '/style-admin.css'); // backend css (admin_enqueue_scripts)
    }

    static function tdn_plugin_frontend_css() {
        wp_enqueue_style('td-plugin-newsletter', plugins_url('', __FILE__) . '/style.css'); // frontend css (wp_enqueue_scripts)
    }
...
//                                    'AWeber'      => 'aweber',
    ...
    function register_styles() {
        ...
        $fonts = array_merge(
            ...
            td_config_helper::get_map_block_font_array( 'f_disclaimer', false, 'Disclaimer text', 'Style' ),
