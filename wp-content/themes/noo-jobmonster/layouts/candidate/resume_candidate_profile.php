	...
	<div class="resume-candidate-profile">
		<div class="row">
			...
			<div class="col-sm-9 candidate-detail">
				...
				if ( $enable_socials && !empty($html) && count($html) > 0) : ?>
                    <div class="candidate-social">
						<?php echo implode("\n", $html); ?>
                    </div>
				<?php endif; ?>
				<?php if ( $enable_print ) : ?>
                    <a class="print-resume noo-icon" href="javascript:void(0)" onclick="return window.print();" title="<?php echo __('Print', 'noo'); ?>" title="<?php echo esc_attr__('Print', 'noo'); ?>">
