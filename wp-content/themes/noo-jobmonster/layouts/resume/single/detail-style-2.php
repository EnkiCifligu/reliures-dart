     ...
     <div class="resume-content <?php echo esc_attr($resume_content_col_class); ?>">
        <div class="resume-about">
            <div class="resume-about">
	            ...
	            <?php if( !apply_filters( 'jm_resume_hide_candidate_contact', $hide_profile, $resume_id ) ) : ?>
	            ...
	            <?php else: ?>
                <?php echo esc_html__('You cannot view contact detail.', 'noo'); ?>
	            <?php endif; ?>
            </div>
        </div>
     ...
     <div class="resume-sidebar col-md-4">
        <form class="resume-contact" method="POST">
            <h3 class="noo-heading">
                ...
                <?php echo esc_html__( 'Contact', 'noo' ) ?>
            </h3>
            <div class="resume-contact-item">
                <input type="text" name="name" placeholder="<?php echo esc_html__( 'Name *', 'noo' ) ?>" />
            </div>
            <div class="resume-contact-item">
                <input type="text" name="mail" placeholder="<?php echo esc_html__( 'Email address *', 'noo' ) ?>" />
            </div>
            <div class="resume-contact-item">
                <input type="text" name="phone" placeholder="<?php echo esc_html__( 'Phone Number *', 'noo' ) ?>" />
            </div>
            <div class="resume-contact-item">
