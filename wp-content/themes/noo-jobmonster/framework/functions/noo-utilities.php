...
if ( ! function_exists( 'noo_company_review' ) ) :
	...
	function noo_company_review() {
		...
		$response = array();
		if ( isset( $_POST[ 'company_id' ] ) && isset( $_POST[ 'user_name' ] ) && isset( $_POST[ 'user_email' ] ) && isset( $_POST[ 'subject' ] ) && isset( $_POST[ 'score-wlb' ] ) && isset( $_POST[ 'score-cb' ] ) && isset( $_POST[ 'score-sm' ] ) && isset( $_POST[ 'score-cv' ] ) && isset( $_POST[ 'message' ] ) ) {
			$company_id = absint( $_POST[ 'company_id' ] );
