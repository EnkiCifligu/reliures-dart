    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              ...
              <div class="know-btn">
                <a href="<?php the_permalink(); ?>"><?php echo esc_html_e('KNOW MORE','ts-mobile-app'); ?></a>
              </div> 
            </div>
        </div>
        <?php $i++; endwhile; 
  ...
  <div class="row m-0">
    <?php 
      ...
      <?php $counter = 1; ?>
        <?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
        <div class="col-lg-3 col-md-3 p-0">
          <div class="service post-list-<?php echo esc_html( ts_mobile_app_odd_or_even($counter)); ?>">
            <?php if(has_post_thumbnail()) { ?><?php the_post_thumbnail(); ?><?php } ?>
  ...
  if ( $query->have_posts() ) :
    ...
    <div class="row m-0">
      ...
      <div class="col-lg-6 col-md-6">
        ...
        <p><?php the_excerpt(); ?></p>
        <div class="know-btn">
          <a href="<?php the_permalink(); ?>"><?php echo esc_html_e('READ MORE','ts-mobile-app'); ?></a>
        </div>
      </div>
    </div>
    <?php endwhile; 
